...
const elements = {
  ...
  mapClickPrompt: document.querySelector("#mapClickPrompt"),
...
window.addEventListener("resize", () => {
  if (!game.currentCountry || game.isTransitionPreparing || resizeFrame) {
    return;
  }
  ...
  resizeFrame = window.requestAnimationFrame(() => {
    ...
    if (!game.currentCountry || game.isTransitionPreparing) {
      return;
    }
